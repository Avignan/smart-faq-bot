...
from backend.scripts.rag_engine import get_answer, chunk_text
from  backend.scripts.utils import db_connection, preprocess_docx, extract_text_from_docx
import os
import uuid
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://smart-faq-bot.netlify.app", "http://localhost:3000"],
